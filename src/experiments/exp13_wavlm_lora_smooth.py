...
def run_exp13_wavlm_lora_smooth(
    music_dir: Path,
    cache_dir: Path,
    projector_ckpt: Path,
    edge_repo_dir: Path,
    ...
    """
    Experiment 13:
    WavLM + LoRA + smoothness regularisation + EDGE inference.

    Note:
        This entrypoint assumes the final projector checkpoint already exists.
    """
